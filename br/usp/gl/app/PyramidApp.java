...
import br.usp.gl.models.Pyramid;
...
public class PyramidApp extends GLOrthoApp implements KeyListener {
	...
	public void init(final GLAutoDrawable drawable) {
		...
		pyramid.init(gl, shaderProgram.getAttribLocation("aVertexPosition"));
		pyramid.bind();
	}
