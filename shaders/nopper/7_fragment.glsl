...
void main(void)
{
	...
	// DirectX: Origin of uv is upper left. 
	// OpenGL: Origin of st is lower left. Normal vector points "towards" us in both cases.
	// As normal maps usually are created for DirectX, 
	// we have to convert from DirectX to OpenGL tangent space.
	vec3 normal;
