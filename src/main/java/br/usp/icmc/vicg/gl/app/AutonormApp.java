...
import br.usp.icmc.vicg.gl.core.GLOrthoApp;
import br.usp.icmc.vicg.gl.core.Light;
import br.usp.icmc.vicg.gl.models.JsonModel;


public class AutonormApp extends GLOrthoApp implements KeyListener {

	public static final int FPS = 60;
	public static final String SHADERS_FOLDER = "resources/shaders/autonorm/";
